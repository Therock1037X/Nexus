  ...
  return (
    <div className="clean-card p-6 space-y-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-4 text-xs">
        {/* Category Selector */}
        <div>
          <label className="block text-slate-700 font-semibold mb-2">Resource Category</label>
            ...
            {[
              ...
              return (
                <button
                  ...
                  className={`p-3 rounded-xl flex items-center justify-center gap-2 font-semibold border transition-all ${
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
          <div>
            <label className="block text-slate-700 font-semibold mb-1">Unique Resource ID</label>
            <input
              type="text"
              value={resourceId}
              onChange={(e) => setResourceId(e.target.value)}
              className="clean-input w-full font-mono text-emerald-800 font-bold"
              required
            />
          </div>
        ...
        {resourceType !== 'medicine' && (
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
            <div>
              <label className="block text-slate-700 font-semibold mb-1">Assigned Floor</label>
              <select
                value={floorId}
            ...
            <div>
              <label className="block text-slate-700 font-semibold mb-1">Room / Bay No</label>
              <input
                type="text"
                value={roomNo}
        ...
        {resourceType === 'medicine' && (
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
            <div>
              <label className="block text-slate-700 font-semibold mb-1">Initial Stock Quantity</label>
              <input
                type="number"
                value={quantity}
